...
class UploadDocumentMemberScreen extends StatefulWidget {
  UploadDocumentMemberScreen({Key key}) : super(key: key);

  @override
  _UploadDocumentMemberScreenState createState() =>
      _UploadDocumentMemberScreenState();
}

class _UploadDocumentMemberScreenState
    extends State<UploadDocumentMemberScreen> {
                    ...
                    children: [
                        ...
                        child: CustomButtonOutline(
                            ...
                            onTap: () {
                              ImageUtil().postImageCamera((file) {
                                ...
                                _utilBloc.add(UploadPrivateEvent(
                      ...
                      Expanded(
                        child: CustomButtonRaised(
                          title: 'Simpan',
                          isCompleted: _urlPhoto != null,
                          onTap: () => Navigator.pop(context, _objectPhoto),
                        ),
                      ),
                    ],
                  )
