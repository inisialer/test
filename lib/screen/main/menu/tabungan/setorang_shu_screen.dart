...
import '../../../../model/tabungan/mutasi_tagihan_model.dart';
import 'bayar_setoran_awal_screen.dart';

class SetoranSHUScreen extends StatefulWidget {
  const SetoranSHUScreen() : super();

  @override
  State<SetoranSHUScreen> createState() => _SetoranSHUScreenState();
}

class _SetoranSHUScreenState extends State<SetoranSHUScreen> {
  ...
  getData() async {
    MutationSavingModel mutationSavingModel = await TabunganListService()
        .getMutasiTabungan(tabunganListModel.data[2].id);
