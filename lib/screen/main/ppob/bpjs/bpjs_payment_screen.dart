...
class BpjsPaymentScreen extends StatefulWidget {
  const BpjsPaymentScreen({Key key}) : super(key: key);

  @override
  _BpjsPaymentScreenState createState() => _BpjsPaymentScreenState();
}

class _BpjsPaymentScreenState extends State<BpjsPaymentScreen> {
  BpjsPaymentArguments args;
      ...
      listener: (context, state) {
        if (state is BillerPaymentMethodSuccessState) {
          ...
          var data = PaymentConfirmModel(
              ...
              menuDataNoOrName: 'No. VA Keluarga',
              menuDataType: 'Pembayaran',
              bank: _itemBank,
              bpjsNo: args.data.no,
              bpjsName: args.data.name,
...
class BpjsPaymentArguments {
  final PaymentModel data;

  BpjsPaymentArguments(this.data);
}
