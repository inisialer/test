...
class PlnPaymentScreen extends StatefulWidget {
  const PlnPaymentScreen({Key key}) : super(key: key);

  @override
  _PlnPaymentScreenState createState() => _PlnPaymentScreenState();
}

class _PlnPaymentScreenState extends State<PlnPaymentScreen> {
  PlnPaymentArguments args;
      ...
      listener: (context, state) {
        if (state is BillerPaymentMethodSuccessState) {
          ...
          var data = PaymentConfirmModel(
              ...
              menuDataNoOrName: 'No. Meter ID',
              menuDataType: 'Pembayaran',
              plnNo: args.data.plnNo,
              bank: _itemBank);
...
class PlnPaymentArguments {
  final PaymentModel data;

  PlnPaymentArguments(this.data);
}
