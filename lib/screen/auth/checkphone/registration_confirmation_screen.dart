...
class RegistrationConfirmationScreen extends StatelessWidget {
  RegistrationConfirmationScreen({Key key}) : super(key: key);

  ScreenUtil _screen = ScreenUtil();

  CheckPinArguments args;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Sambungkan akun Zipay sebagai pembayaran pada aplikasi ini?",
              ...
              children: [
                        ...
                        child: InkWell(
                          child: Text("DISINI",
                              style: TextStyle(
                                  ...
                                  fontSize: 16,
                                  color: AppUtil().parseHexColor("00C2FF"))),
                        ),
                      )
                    ],
                  ),
                ...
                Container(
                  ...
                  child: CustomButtonRaised(
                    ...
                    width: _screen.widthDefault(context) * 0.7,
                    onTap: () {
                      MyNavigator.goToCheckPin(context, args);
                    },
                    title: "Sambungkan Akun",
                  ),
                ),
                Text(
